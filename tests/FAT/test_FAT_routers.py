...
class TestFATRouters(TestCase):
    ...
    def setUp(self):
        ...
        self.db_3 = 'ftse100'
        self.model_4 = apps.get_model('Analysis', 'ZAL_DE')
        self.db_4 = 'dax40'
    ...
    def test_db_for_read(self):
        ...
        self.model_4.__name__ = self.model_4.__name__.lower()
        db = self.router.db_for_read(self.model_4)
        self.assertEqual(db, self.db_4, " - [NO OK] Enrutar a BD adecuada")
        self.log.info(" - [OK] Enrutar a BD adecuada")