...
class TestsUnitarios_BDs(TestCase):
    ...
    def test_02_longitudIndices(self):
        ...
        self.logger_BDs.info(" - [OK] Tener 30 tickers (+ índice) en la lista del DJ30")
        self.assertEqual(len(self.tickers_ibex35), 35 + 1, " - [NO OK] Tener 35 tickers (+ índice) en la lista del IBEX35")
        self.logger_BDs.info(" - [OK] Tener 35 tickers (+ índice) en la lista del IBEX35")
    ...
    def test_03_tablasDJ30(self):
        ...
        self.logger_BDs.info(" - [OK] Tener 31 (tickers + índidce) tablas en DJ30")
        self.logger_BDs.info("")
    ...
    def test_05_tablasIBEX35(self):
        ...
        self.logger_BDs.info(" - [OK] Tener 36 tablas (tickers + índidce) en IBEX35")
        self.logger_BDs.info("")
        # Comprobar que todos los tickers tienen su 
        # correspondiente tabla en la BD
        for ticker in self.tickers_ibex35:
