...
%    \begin{figure}[!h]
%        \centering
%        \includegraphics[width=1.3\textwidth, center]{#1} % Ajustar el ancho para que sobresalga del margen
%        \caption{#2}\label{fig:#1}
%    \end{figure}
%    \FloatBarrier
%}
...
\newcommand{\imagenSinMargen}[2]{
    \begin{figure}[!h]
        \makebox[\textwidth][c]{\includegraphics[width=1.45\textwidth]{#1}} % Ajusta el ancho para sobresalir ambos márgenes
        \caption{#2}\label{fig:#1}
    \end{figure}
    \FloatBarrier
}
