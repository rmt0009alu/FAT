...
información técnica y fundamental de empresas y sus productos cotizados, así como noticias 
...
gráfico de correlación entre las cotizaciones de cuatro bolsas mundiales o la experimentación 
con predicción automática sobre series temporales, a través de \emph{ARIMA} o redes \emph{LSTM}. 
...
\begin{abstract}
Django, SQLite, análisis financiero, noticias y RSS, seguimiento de cartera, \emph{forecasting} de 
series temporales. 
\end{abstract}
...
some uncommon utilities, such as the option to perform graphical correlation analysis between the stock quotes 
from four world stock exchanges, or experimentation with automatic prediction on time series, through 
ARIMA or LSTM networks.
...
The tool is available at \url{http://takeiteasy.pythonanywhere.com/} or, for local use, at
\url{https://github.com/rmt0009alu/FAT}.
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Django, SQLite, financial analysis, news and RSS, investment portfolio, time series \emph{forecasting}. 
\end{abstract}
