...
Algunos casos especiales de ARIMA son los siguientes:
...
%\section{Análisis de series temporales}\label{series_temporales}
%
%Cuando hacemos un análisis de la evolución de los precios de una acción podemos cometer el error de centrarnos en los datos de un momento concreto en el tiempo, pero debemos tener en cuenta que los precios evolucionan con el tiempo. 
%
%Cuando hablamos de \emph{forecasting} (previsión o predicción) de series temporales con productos financieros   una de las cosas que hay que tener en cuenta es que es un proceso especialmente complicado y que los resultados obtenidos, en muchas ocasiones, son erróneos. Por ello, en este trabajo se propone un laboratorio virtual que le permita al usuario experimentar con algunas herramientas relativas al análisis de series temporales y que sea esa persona la que saque sus propias conclusiones a través de los datos obtenidos. 
%
%
%
%
