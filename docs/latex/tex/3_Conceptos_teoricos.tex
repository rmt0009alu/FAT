...
\tablaSmall{Cómo almacenar señales para algoritmo de seguimiento de tendencias}
{c|c|c|c|c|c}
...
\tablaSmall{Cómo almacenar retornos para algoritmo de seguimiento de tendencias}
{c|c|c}
...
\tablaSmall{Medias móviles simples frecuentes}
{c|c}
...
La selección de los valores que \emph{representarán} a todo el índice serán:

\tablaSmall{Valores seleccionados de cada índice}
{c|c|c|c}
